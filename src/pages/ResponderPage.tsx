...
export const ResponderPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Map area - Account for navbar height */}
      ...
      <div className="pointer-events-none absolute inset-0 z-[1000]">
        <div className="absolute left-6 bottom-24 flex flex-col space-y-3 pointer-events-auto">
          {canUseRouting ? (
            <>
              ...
              {routingEnabled && (
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-semibold shadow-lg transition-all duration-200 ${
                    tallVehicleRouting 
            ...
            <div className="px-4 py-2 bg-red-500 text-white rounded-lg font-semibold shadow-lg">
